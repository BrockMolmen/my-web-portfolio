  ...
  return (
    <div className="bump">
      <div className="stack-it" >
        ...
        <div className="project-container stack-it">
          <div>
            <h1 className="project-title">Technical Skills</h1>
          </div>
          <div>
            <ul className="tech-skills-list">
              <li> <FontAwesomeIcon icon={faHtml5} className="icon-1" size="2x" /> Html </li>
              <li> <FontAwesomeIcon icon={faCss3Alt} className="icon-2" size="2x" /> CSS </li>
              <li> <FontAwesomeIcon icon={faSass} className="icon-3" size="2x" /> Sass </li>
              <li> <FontAwesomeIcon icon={faReact} className="icon-1" size="2x" /> React </li>
              <li> <FontAwesomeIcon icon={faCogs} className="icon-2" size="2x" /> Express </li>
              <li> <FontAwesomeIcon icon={faLevelUpAlt} className="icon-3" size="2x" /> Sequelize </li>
              <li> <FontAwesomeIcon icon={faNode} className="icon-1" size="2x" /> Node.js </li>
              <li> <FontAwesomeIcon icon={faDatabase} className="icon-2" size="2x" /> PostgreSQL </li>
              <li> <FontAwesomeIcon icon={faJsSquare} className="icon-3" size="2x" /> Javascript </li>
              <li> <FontAwesomeIcon icon={faPython} className="icon-1" size="2x" /> Python </li>
            </ul>
          </div>
        </div>
      </div>
